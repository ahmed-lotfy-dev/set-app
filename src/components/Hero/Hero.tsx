...
export default function Hero({ }: Props) {
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="w-full flex-1 flex flex-col justify-start items-center relative"
    >
      ...
      <motion.div variants={centerVariants} className="flex flex-col items-center z-20">
        ...
        <div className="flex items-center gap-5 mt-12 mb-6.75">
          <a
            href="#"
            className="bg-white text-black font-normal px-7.5 h-[60px] rounded-btn flex items-center text-lg cursor-pointer transition-transform hover:scale-105"
          >
            Try free for 7 days
          </a>
          <div className="flex items-center gap-3">
            <a
              href="#"
              className="w-[60px] h-[60px] bg-white rounded-btn flex justify-center items-center shadow-lg transition-transform hover:scale-105 cursor-pointer"
            >
      ...
      {/* Shapes Group - Left */}
      <motion.div variants={shapeVariants} className="absolute top-[46px] left-[116px]">
      ...
      <motion.div variants={shapeVariants} className="absolute top-[177px] left-[115px]">
        <img className="inset-0 w-full h-full object-contain" src={secondLeftShape} alt="Floating Shape" />
      </motion.div>

      <motion.div variants={shapeVariants} className="absolute top-[170px] left-[220px]">
        <img className="inset-0 w-full h-full object-contain" src={thirdLeftShape} alt="Floating Shape" />
      </motion.div>

      <motion.div variants={shapeVariants} className="absolute top-[338.5px] left-[111px]">
      ...
      <motion.div variants={shapeVariants} className="absolute top-[418px] left-[110px]">
      ...
      {/* Shapes Group - Right */}
      <motion.div variants={shapeVariants} className="absolute top-[63px] right-[69px]">
      ...
      <motion.div variants={shapeVariants} className="absolute top-[124px] right-[194px]">
        <div className="relative flex justify-center items-center w-44 h-44">
          <img
            className="absolute inset-0 w-full h-full object-contain"
      ...
      <motion.div variants={shapeVariants} className="absolute top-[235px] right-[56px] z-10">
        <div className="relative flex justify-center items-center">
          <img className="inset-0 w-full h-full object-contain" src={thirdRightShape} alt="Floating Shape" />
        </div>
      </motion.div>

      <motion.div variants={shapeVariants} className="absolute top-[336px] right-[114px]">
